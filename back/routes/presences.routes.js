...
router.get("/stats/aujourdhui", checkRole(["Administrateur", "RH", "Directeur"]), presencesController.getTodayStats);    // GET /api/presences/stats/aujourdhui -> stats du jour
...
router.put("/:id/rattrapage", checkRole(["Administrateur", "RH", "Directeur"]), presencesController.rattrapage);         // PUT /api/presences/5/rattrapage -> corriger
